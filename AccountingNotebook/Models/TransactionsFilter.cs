...
namespace AccountingNotebook.Models
{
    public class TransactionsFilter
    {
        ...
        public AmountParams AmountParams { get; set; } = AmountParams.Two; // todo: remove
        ...
        public DateTime BotDate { get; set; } = new DateTime(0,0,0,0,0,0); // todo: fix english (from-to)
